package de.schneider21.mensacoldbowl.framework;
    ...
    public Response serve(IHTTPSession session) {
        ...
        if (session.getMethod() == Method.GET) {
            for (RestController restController : restControllers) {
                for (Map.Entry<String, Function<RestController.IRequestParameters, Object>> httpGetMapping : restController.httpGetMappings().entrySet()) {
